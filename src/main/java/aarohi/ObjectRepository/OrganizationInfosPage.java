...
public class OrganizationInfosPage {

	@FindBy (name="Edit") private WebElement EditBtn;
	@FindBy (name="Duplicate") private WebElement DuplicateBtn;
	@FindBy (name="Delete") private WebElement DeleteBtn;
	@FindBy (id="dtlview_Organization Name") private WebElement OrgHeaderTxt;
	
	public OrganizationInfosPage(WebDriver driver) {
